...
import edu.nwu.museum.common.domain.QueryRequest;
...
public class SortUtil {
   ...
   */
  public static void handlePageSort(QueryRequest request, Page page, String defaultSort,
    ...
    if (StringUtils.isNotBlank(request.getSortField())
      ...
      if (StringUtils.equals(request.getSortOrder(), CommonConstant.ORDER_DESC)) {
      ...
      if (StringUtils.isNotBlank(defaultSort)) {
        if (StringUtils.equals(defaultOrder, CommonConstant.ORDER_DESC)) {
